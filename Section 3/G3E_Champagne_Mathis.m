...
for i = 1:length(Start)
    ...
    noverlap = 0;%pas de recouvrement
    ...
    xlabel('Temps (s)');
    ylabel('Fréquence (Hz)');
    %Le spectrogramme apporte une information temporelle et fréquentielle locale sur l'évolution du signal 
    % sonore, alors que la DFT de l'intégralité du son ne donne qu'une information globale sur le spectre 
    % fréquentiel. Le spectrogramme permet donc de visualiser comment la fréquence du signal évolue dans le 
    % temps.
